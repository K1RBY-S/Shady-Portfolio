  ...
  return (
    <section id="Home" className="px-16 flex flex-col min-h-screen w-full items-center justify-center gap-8 py-28 md:px-32">
      ...
      <div className="flex max-w-[600px] flex-col items-center justify-center gap-3 text-center">
        ...
        className="text-5xl font-bold text-black md:text-6xl">Shady Dajani</motion.h1>
        ...
        className="text-2xl font-semibold text-black md:text-3xl">Data Analyst</motion.h3>
        
        <motion.p
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.3 }}
        className="text-md text-gray-800 md:text-base text-pretty">
